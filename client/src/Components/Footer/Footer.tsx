        ...
        <div className="footer">
            <div className="logos_container">
                <div className="right_logo">
                   <img src='./ieee-sscs-sm-ko-logo2x 1.png' alt="IEEE SSCS logo" className="footer-logo" />
                </div>
                <div className="left_logo">
                    <a href='https://www.ieee.org/' target='_blank' rel='noopener noreferrer'>
                        <img src='./IEEE-logo.png' alt='IEEE logo' className="footer-logo" />
                    </a>
                    <div className="social_icons">
                       {/* Instagram */}
                       <a href="https://www.instagram.com/sscsalex?igsh=MXdrcW9yaGR6dWoyOA==" target="_blank" rel="noopener noreferrer">
                       <svg width="40" height="40" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="social-icon">
